 ...
 *
 * The routines implemented here must be implemented per platform and according to the requirements denoted in the
...
/**
 */
KI_NATIVE extern KiTVoid *KI_CALL KiPlatform_ResolveSymbol(
    KiTDynLibHandle libHandle,
    KiTChar const *symName
) KI_VIRTUAL;

/**
 */
KI_NATIVE extern KiEErrorCode KI_CALL KiPlatform_VirtualReserve(
    KiTVoid *stAddr,
    KiTSize reqSz,
    KiTVoid **resPtr
) KI_VIRTUAL;
 ...
 */
KI_NATIVE extern KiEErrorCode KI_CALL KiPlatform_VirtualCommit(
    KiTVoid *stAddr,
    KiTSize reqSz,
    KiTVoid **resPtr
) KI_VIRTUAL;
...
/**
 */
KI_NATIVE extern KiEErrorCode KI_CALL KiVirtual_KrnlRWLockCreate(KiSKrnlRWLock **resPtr) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiVirtual_KrnlRWLockDestroy(KiSKrnlRWLock *rwLockPtr) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiVirtual_KrnlRWLockAcquireRead(KiSKrnlRWLock *rwLockPtr) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiVirtual_KrnlRWLockReleaseRead(KiSKrnlRWLock *rwLockPtr) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiVirtual_KrnlRWLockAcquireWrite(KiSKrnlRWLock *rwLockPtr) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiVirtual_KrnlRWLockReleaseWrite(KiSKrnlRWLock *rwLockPtr) KI_VIRTUAL;

/**
 */
KI_NATIVE extern KiTVoid KI_CALL KiPlatform_DbgNotify(
    KiTChar const *mBuf,
    KiSDebugTerminationContext const *tCtxt
) KI_VIRTUAL;
/**
 */
KI_NATIVE extern KI_NORETURN KiTVoid KI_CALL KiPlatform_DbgExit(KiEErrorCode errCode) KI_VIRTUAL;
