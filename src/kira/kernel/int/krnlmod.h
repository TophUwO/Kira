...
#define KI_KRNLMOD(modId, deps, ...)                                                                           \
    extern KiEErrorCode KI_CALL KiInternal_Init##modId(KiTVoid *extraParam);                                   \
    extern KiEErrorCode KI_CALL KiInternal_Uninit##modId(KiTVoid *extraParam);                                 \
    ...
    __attribute__((section("KIRA_KMD"), used)) static KiSKernelModuleInfo const gl_c_##modId##_Info = {        \
        ...
        .mp_fnInit     = &KI_KRNLMOD_INITFN(modId),                                                            \
        .mp_fnUninit   = &KI_KRNLMOD_UNINITFN(modId),                                                          \
