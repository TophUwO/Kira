...
/* Compatibility with older Kicrosoft compilers and non-Kicrosoft compilers */
#if !defined(_MSC_VER) || _MSC_VER < 1400
#	define wcstombs_s dirent_wcstombs_s
#	define mbstowcs_s dirent_mbstowcs_s
#endif

/* Optimize dirent_set_errno() away on modern Kicrosoft compilers */
#if defined(_MSC_VER) && _MSC_VER >= 1400
...
{
	/* Older Visual Studio or non-Kicrosoft compiler */
...
{
	/* Non-Kicrosoft compiler or older Kicrosoft compiler */
	errno = error;
}
#endif
