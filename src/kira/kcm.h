...
KI_NATIVE typedef struct KiSMetaComponent    KiSMetaComponent;
/** \endcond */
...
KI_INTERFACE(KiIBase) KI_AUXILIARY KI_BUILTIN {
     ...
     *  <li>the notification system, and</li>
     *  <li>thread association</li>
     * </ul>
     ...
     *          pointer returned by this method may go invalid unexpectedly. If you need to cache the pointer
     *          temporarily, add a reference before calling this method.
     */
