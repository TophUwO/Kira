 ...
 * \c KiPP (<b>Ki</b>ra <b>P</b>re<b>p</b>rocessor), this is automatically handled for you.
 * 
...
KI_INTERFACE(KiIBase) KI_AUXILIARY KI_BUILTIN {
     ...
     * \param   [in] iidPtr pointer to the interface identifier of the interface that is to be queried
     * \param   [in] resPtr pointer to a variable that will receive the pointer to the queried interface
